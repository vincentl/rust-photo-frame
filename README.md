...
3. **Tune the experience** — [docs/configure.md](docs/configure.md): transitions, mats, schedule
4. **Run it day-to-day** — [docs/operate.md](docs/operate.md): commands and troubleshooting
